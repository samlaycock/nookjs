...
export class Interpreter {
  ...
  public evaluateNode(node: ASTNode): any {
    ...
    switch (node.type) {
      ...
      case "TaggedTemplateExpression":
        return this.evaluateTaggedTemplateExpression(
  ...
  public async evaluateNodeAsync(node: ASTNode): Promise<any> {
    ...
    switch (node.type) {
      ...
      case "LabeledStatement":
        return await this.evaluateLabeledStatementAsync(
          node as ESTree.LabeledStatement,
        );
      ...
      case "SequenceExpression":
        return await this.evaluateSequenceExpressionAsync(
          node as ESTree.SequenceExpression,
        );
  ...
  private resolveMemberExpressionValue(
    ...
    if (node.computed) {
      ...
      if (Array.isArray(object)) {
        ...
        throw new InterpreterError(
          `Array property '${property}' not supported`,
        );
      }
      ...
      if (typeof object === "string") {
        ...
        throw new InterpreterError(
          `String property '${property}' not supported`,
        );
      }
