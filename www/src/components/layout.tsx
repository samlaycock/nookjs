...
export function Layout() {
  ...
  return (
    <div className="flex flex-col min-h-screen w-screen font-mono bg-neutral-950">
      <header className="flex flex-row justify-between items-center gap-4 p-4 sm:gap-6 sm:p-6 border-b border-neutral-800">
