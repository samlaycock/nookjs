  ...
  return (
    <article className="prose prose-invert max-w-none">
      ...
      <p className="text-xl text-neutral-300 mb-8">
        A simplified, ergonomic API built on top of the Interpreter. Use it for
        most integrations.
      </p>
...
console.log(result); // 6.28318`}
      ...
      <section className="mb-12">
        ...
        <p className="text-neutral-300 mt-4 mb-4">
          Builds a reusable sandbox with intuitive options for language presets,
          API add-ons, globals, and limits.
        </p>
        <CodeBlock
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2">
          <div className="p-4 bg-neutral-900 border border-neutral-800 rounded">
            ...
            <p className="text-sm text-neutral-400">
              Language preset: "minimal", "es2022", "esnext", "browser", "node",
              "wintercg".
            </p>
          </div>
          <div className="p-4 bg-neutral-900 border border-neutral-800 rounded">
            ...
            <p className="text-sm text-neutral-400">
              Add-on globals: "fetch", "console", "timers", "text", "crypto",
              "streams", "blob".
            </p>
          </div>
          <div className="p-4 bg-neutral-900 border border-neutral-800 rounded">
            ...
            <p className="text-sm text-neutral-400">
              Enable/disable language features without building full
              featureControl lists.
            </p>
          </div>
          <div className="p-4 bg-neutral-900 border border-neutral-800 rounded">
            <h3 className="text-lg font-medium text-neutral-100 mb-2">
            ...
            <p className="text-sm text-neutral-400">
              Guard per-run execution and cumulative usage. Total limits enable
              resource tracking.
            </p>
          </div>
        </div>
...
console.log(ast.type); // Program`}
      ...
      <section className="mb-12">
        ...
        <p className="text-neutral-300 mb-4">
          Provide module sources directly, or use a custom resolver for advanced
          use cases.
        </p>
        <CodeBlock
          code={`const sandbox = createSandbox({
...
console.log(exports.result); // 3`}
        ...
        <div className="p-4 bg-amber-950/30 border border-amber-800/50 rounded mt-6">
          ...
          <p className="text-neutral-300 text-sm">
            ...
            <code className="text-amber-400">runModule()</code>). Script
            evaluation via <code className="text-amber-400">run()</code> only
            allows
